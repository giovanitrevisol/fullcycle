...
type TransactionGatawayMock struct {
	mock.Mock
}

func (m *TransactionGatawayMock) Create(transaction *entity.Transaction) error {
...
func TestCreateTransactinUseCase_Execute(t *testing.T) {
	...
	mockTransaction := &TransactionGatawayMock{}

...
import com.gt.admin.catalogo.application.video.media.upload.DefaultUploadMediaUseCase;
import com.gt.admin.catalogo.application.video.media.upload.UploadMediaCommand;
...
import com.gt.admin.catalogo.domain.video.VideoResource;
...
public class UploadMediaUseCaseTest extends UseCaseTest {
        ...
        public void givenCmdToUpload_whenIsValid_shouldUpdateVideoMediaAndPersistIt() {
                ...
                verify(videoGateway, times(1)).update(
                                argThat(actualVideo -> Objects.equals(expectedMedia, actualVideo.getVideo().get())

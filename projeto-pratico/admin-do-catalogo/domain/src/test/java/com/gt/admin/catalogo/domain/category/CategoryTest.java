...
import com.gt.admin.catalogo.domain.validation.handler.ThrowsValidationHandler;
...
class CategoryTest {
    ...
    @Test
    public void givenAValildParams_whenCallNewCataegory_thenInstantiateACategory(){
    ...
    @Test
    public void givenAnInvalidNullName_whenCallNewCataegoryAndValidade_thenShouldReturnError(){
    ...
    @Test
    public void givenAnInvalidEmptyName_whenCallNewCataegoryAndValidade_thenShouldReturnError(){
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenReturnCategoryInactivate(){
        ...
        final Instant updateAt = aCategory.getUpdatedAt();

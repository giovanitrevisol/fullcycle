package com.gt.admin.catalogo.e2e;
...
import com.gt.admin.catalogo.infrastructure.category.models.CreateCategoryRequest;
import com.gt.admin.catalogo.infrastructure.category.models.UpdateCategoryRequest;
...
public interface MockDsl {
    ...
    default ResultActions updateACastMember(final CastMemberID anId, final String aName, final CastMemberType aType)
            throws Exception {
    ...
    default GenreID givenAGenre(final String aName, final boolean isActive, final List<CategoryID> categories)
            throws Exception {

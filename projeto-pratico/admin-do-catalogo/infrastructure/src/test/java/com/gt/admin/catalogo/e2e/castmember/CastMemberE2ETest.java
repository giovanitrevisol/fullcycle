package com.gt.admin.catalogo.e2e.castmember;

import com.gt.admin.catalogo.E2ETest;
...
import com.gt.admin.catalogo.e2e.MockDsl;
...
public class CastMemberE2ETest implements MockDsl {
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToSeeATreatedErrorByCreatingANewCastMemberWithInvalidValues()
            throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, castMemberRepository.count());

...
import com.gt.admin.catalogo.infrastructure.video.DefaultVideoGateway;
...
public class DefaultVideoGatewayTest {
        ...
        public void givenAValidCategory_whenCallFindAll_shouldReturnFilteredList() {
                ...
                Assertions.assertEquals("21.1 Implementação dos testes integrados do findAll",
                                actualPage.items().get(0).title());
